  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Sombra mais presente para elementos "flutuantes" de destaque
        // (banner, cartão de informações do estabelecimento).
        elevated: '0 4px 16px rgba(0,0,0,0.06), 0 20px 48px -16px rgba(0,0,0,0.18)',
      },
    },
  },
  plugins: [],
