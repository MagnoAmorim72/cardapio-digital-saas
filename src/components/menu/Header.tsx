      ...
      <div className="mx-auto max-w-3xl px-4 pb-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-full border border-ink/10 bg-surface-raised py-2.5 pl-9 pr-4 text-sm text-ink placeholder:text-ink-muted focus:outline-none focus:ring-2 focus:ring-brand-primary"
          />
        </div>
      </div>
    </header>
