...
export function Footer({ tenant }: { tenant: Tenant }) {
  return (
    <footer className="mt-10 border-t border-ink/10 bg-surface-raised/50 px-4 py-8">
      <div className="mx-auto max-w-3xl">
        <h3 className="mb-3 font-display text-sm font-bold text-ink">Horário de funcionamento</h3>
